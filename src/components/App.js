...
import { applyNumber, changeOperation, clearDisplay, memPlus, memR, memClear } from '../actions';
      ...
      <div className="container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => memPlusHandler()} />
              <CalcButton value={"MR"} onClick={() => memRHandler()} />
